    ...
    def _run_command(self, args: list[str]) -> str:
        ...
        for attempt in range(max_retries + 1):
            try:
                ...
                is_rate_limit = (
                    "429" in e.stderr or "resource_exhausted" in stderr_lower
                )
    ...
    def fetch_all_contacts(self, page_size: int = 100) -> list[StandardContact]:
        ...
        while True:
            args = [
                ...
                "list-connections",
                "--read-mask",
                "names,emailAddresses,urls,imClients,phoneNumbers",
                "--page-size",
                str(page_size),
            ]
            if page_token:
    ...
    def get_contact(self, resource_name: str) -> Optional[StandardContact]:
        ...
        stdout = self._run_command(
            [
                ...
                resource_name,
                "--read-mask",
                "names,emailAddresses,urls,imClients,phoneNumbers,metadata",
            ]
        )
